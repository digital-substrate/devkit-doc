...
| Layer           | Guarantees                                               |
|-----------------|----------------------------------------------------------|
| **Commit**      | DAG consistency, immutability, and a reduction that is deterministic given a fixed merge sequence — see *What Commit Does NOT Provide* for what it drops |
